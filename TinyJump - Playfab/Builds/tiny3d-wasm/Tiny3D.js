...
updateGlobalBufferAndViews(buffer);
  ...
  HEAP32[DYNAMICTOP_PTR>>2] = 1871168;
...
// {{PRE_LIBRARY}}
  ...
  function _GetBestTime(customId){  
  ...
  function _PlayfabLogin(titleId, customId) {
  ...
  function _SetBestTimePlayfab(val){
  ...
  function _SetGetBestTimeCallback(p){
  ...
  function _SetOnLoginSuccess(pOnLoginSuccess){
  ...
  var _fetch_work_queue=1346864;function __emscripten_get_fetch_work_queue() {
  ...
  function _js_html_setMaxUncompressedAudioBufferBytes(maxUncompressedAudioBufferBytes) {
...
var _malloc,_free,_main,_memset,_unsafeutility_malloc,_unsafeutility_free,_unsafeutility_assertheap,_unsafeutility_memclear,_unsafeutility_memcpystride,_unsafeutility_memcpyreplicate,_unsafeutility_memmove,_unsafeutility_call_p,_unsafeutility_call_pi,_rafcallbackinit_html,_GetOrCreateSharedMemory,_GetStatus,_GetErrorStatus,_Close,_GetData,_RequestAsyncRead,_BGFXAllocator_Init,_BGFXCB_Init,_BGFXCB_Lock,_BGFXCB_UnlockAndClear,_shutdown_html,_destroycallbackinit_html,_pausecallbackinit_html,_RegisterSendMessage,_PlayerConnectionMt_IsAvailableSendStream,_PlayerConnectionMt_Init,_PlayerConnectionMt_DequeSendStream,_PlayerConnectionMt_QueueFreeStream,_PlayerConnectionMt_LockStreamBuilders,_PlayerConnectionMt_UnlockStreamBuilders,_PlayerConnectionMt_Shutdown,_PlayerConnectionMt_QueueSendStream,_init_html,_PlayerConnectionMt_RegisterStreamBuilder,_PlayerConnectionMt_DequeFreeStream,_PlayerConnectionMt_AtomicStore,_PlayerConnectionMt_AtomicCompareExchange,_Time_GetTicksMicrosecondsMonotonic,_strlen,_unsafeutility_realloc,_BGFXCB_DeInit,_ondestroyapp,_onpauseapp,_time_html,_SendMessage,_unsafeutility_memset,_unsafeutility_memcpy,_PlayerConnectionMt_UnregisterStreamBuilder,_PlayerConnectionMt_AtomicAdd64,_PlayerConnectionMt_LockProfilerHashTables,_PlayerConnectionMt_UnlockProfilerHashTables,_Time_GetTicksToNanosecondsConversionRatio_Numerator,_Time_GetTicksToNanosecondsConversionRatio_Denominator,_unsafeutility_get_heap_size,_unsafeutility_memcmp,_GetSecondsMonotonic,_htonl,_htons,_ntohs,__get_tzname,__get_daylight,__get_timezone,stackSave,stackRestore,stackAlloc,___cxa_demangle,_memalign,__growWasmMemory,dynCall_iiii,dynCall_viii,dynCall_iiiii,dynCall_iiiiiiii,dynCall_viiii,dynCall_iiiiiiiiiiiii,dynCall_iiiiiiiiiii,dynCall_viiiiiiii,dynCall_viiiii,dynCall_viiiiii,dynCall_vii,dynCall_viiiiiiiiii,dynCall_viiiiiii,dynCall_vi,dynCall_v,dynCall_iii,dynCall_ii,dynCall_vf,dynCall_fi,dynCall_ji,dynCall_di,dynCall_jii,dynCall_viij,dynCall_iiiiiiiii,dynCall_iid,dynCall_iiiiiii,dynCall_iij,dynCall_iif,dynCall_iiiiii,dynCall_vif,dynCall_iiiiiiiiii,dynCall_iiiiiiiiiiii,dynCall_viiiiiiiii,dynCall_id,dynCall_i,dynCall_vijii,dynCall_iijii,dynCall_jiji,dynCall_iiiiji,dynCall_idi,dynCall_vffff,dynCall_vff,dynCall_vfi,dynCall_viif,dynCall_viff,dynCall_vifff,dynCall_viffff,dynCall_viiiiiiiiiii,dynCall_viifi,dynCall_iidiiii;
